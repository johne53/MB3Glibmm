...
:
  // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(0),
  Glib::Object(Glib::ConstructParams(menuitem_class_.init(), "label", 0, "submenu", const_cast<GMenuModel*>(Glib::unwrap(submenu)), static_cast<char*>(0)))
{
...
{
  Glib::RefPtr<MenuModel> retvalue = Glib::wrap(g_menu_item_get_link(gobj(), link.c_str()));
  if(retvalue)
