...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    gboolean retval = (*base->has_action)(self, action_name);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    gchar** retval = (*base->list_actions)(self);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    gboolean retval = (*base->get_action_enabled)(self, action_name);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    const GVariantType* retval = (*base->get_action_parameter_type)(self, action_name);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    const GVariantType* retval = (*base->get_action_state_type)(self, action_name);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    GVariant* retval = (*base->get_action_state_hint)(self, action_name);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    GVariant* retval = (*base->get_action_state)(self, action_name);
    return retval;
  }
...
bool ActionGroup::query_action(const Glib::ustring& action_name, bool& enabled, Glib::VariantType& parameter_type, Glib::VariantBase& state_hint, Glib::VariantType& state_type, Glib::VariantBase& state)
{
  ...
  const GVariantType* g_parameter_type = 0;
  const GVariantType* g_state_type = 0;
  GVariant* g_state_hint = 0;
  GVariant* g_state = 0;
...
bool ActionGroup::query_action(const Glib::ustring& action_name, bool& enabled, Glib::VariantType& parameter_type, Glib::VariantBase& state_hint, Glib::VariantType& state_type)
{
  ...
  const GVariantType* g_state_type = 0;
  GVariant* g_state_hint = 0;
  bool retvalue = g_action_group_query_action(gobj(), action_name.c_str(), &g_enabled, &g_parameter_type, &g_state_type, &g_state_hint, 0);
enabled = static_cast<bool>(g_enabled);
  parameter_type = Glib::wrap(const_cast<GVariantType*>(g_parameter_type));
  state_type = Glib::wrap(const_cast<GVariantType*>(g_state_type));
  state_hint = Glib::wrap(g_state_hint);
...
bool ActionGroup::query_action(const Glib::ustring& action_name, bool& enabled, Glib::VariantType& parameter_type, Glib::VariantBase& state_hint, Glib::VariantBase& state)
{
  ...
  GVariant* g_state_hint = 0;
  GVariant* g_state = 0;
  bool retvalue = g_action_group_query_action(gobj(), action_name.c_str(), &g_enabled, &g_parameter_type, 0, &g_state_hint, &g_state);
enabled = static_cast<bool>(g_enabled);
  parameter_type = Glib::wrap(const_cast<GVariantType*>(g_parameter_type));
  state_hint = Glib::wrap(g_state_hint);
  state = Glib::wrap(g_state);
...
bool ActionGroup::query_action(const Glib::ustring& action_name, bool& enabled, Glib::VariantType& parameter_type, Glib::VariantBase& state_hint)
{
  ...
  const GVariantType* g_parameter_type = 0;
  GVariant* g_state_hint = 0;
  bool retvalue = g_action_group_query_action(gobj(), action_name.c_str(), &g_enabled, &g_parameter_type, 0, &g_state_hint, 0);
enabled = static_cast<bool>(g_enabled);
  parameter_type = Glib::wrap(const_cast<GVariantType*>(g_parameter_type));
  state_hint = Glib::wrap(g_state_hint);
  return retvalue;
...
bool ActionGroup::query_action(const Glib::ustring& action_name, bool& enabled, Glib::VariantBase& state_hint, Glib::VariantType& state_type, Glib::VariantBase& state)
{
  ...
  GVariant* g_state_hint = 0;
  GVariant* g_state = 0;
  bool retvalue = g_action_group_query_action(gobj(), action_name.c_str(), &g_enabled, 0, &g_state_type, &g_state_hint, &g_state);
enabled = static_cast<bool>(g_enabled);
  state_type = Glib::wrap(const_cast<GVariantType*>(g_state_type));
  state_hint = Glib::wrap(g_state_hint);
  state = Glib::wrap(g_state);
...
bool ActionGroup::query_action(const Glib::ustring& action_name, bool& enabled, Glib::VariantBase& state_hint, Glib::VariantType& state_type)
{
  ...
  const GVariantType* g_state_type = 0;
  GVariant* g_state_hint = 0;
  bool retvalue = g_action_group_query_action(gobj(), action_name.c_str(), &g_enabled, 0, &g_state_type, &g_state_hint, 0);
enabled = static_cast<bool>(g_enabled);
  state_type = Glib::wrap(const_cast<GVariantType*>(g_state_type));
  state_hint = Glib::wrap(g_state_hint);
  return retvalue;
...
bool ActionGroup::query_action(const Glib::ustring& action_name, bool& enabled, Glib::VariantBase& state_hint, Glib::VariantBase& state)
{
  ...
  GVariant* g_state_hint = 0;
  GVariant* g_state = 0;
  bool retvalue = g_action_group_query_action(gobj(), action_name.c_str(), &g_enabled, 0, 0, &g_state_hint, &g_state);
enabled = static_cast<bool>(g_enabled);
  state_hint = Glib::wrap(g_state_hint);
  state = Glib::wrap(g_state);
  return retvalue;
...
bool ActionGroup::query_action(const Glib::ustring& action_name, bool& enabled, Glib::VariantBase& state_hint)
{
  gboolean g_enabled = gboolean();
  GVariant* g_state_hint = 0;
  bool retvalue = g_action_group_query_action(gobj(), action_name.c_str(), &g_enabled, 0, 0, &g_state_hint, 0);
enabled = static_cast<bool>(g_enabled);
  state_hint = Glib::wrap(g_state_hint);
  return retvalue;
}
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->get_action_parameter_type)
  {
    Glib::VariantType retval(Glib::wrap(const_cast<GVariantType*>((*base->get_action_parameter_type)(const_cast<GActionGroup*>(gobj()),name.c_str())), false));
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->get_action_state_type)
  {
    Glib::VariantType retval(Glib::wrap(const_cast<GVariantType*>((*base->get_action_state_type)(const_cast<GActionGroup*>(gobj()),name.c_str())), false));
    return retval;
  }
