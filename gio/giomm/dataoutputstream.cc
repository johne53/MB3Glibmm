...
{
  GError* gerror = 0;
  bool retvalue = g_data_output_stream_put_byte(gobj(), data, 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  bool retvalue = g_data_output_stream_put_int16(gobj(), data, 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  bool retvalue = g_data_output_stream_put_uint16(gobj(), data, 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  bool retvalue = g_data_output_stream_put_int32(gobj(), data, 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  bool retvalue = g_data_output_stream_put_uint32(gobj(), data, 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  bool retvalue = g_data_output_stream_put_int64(gobj(), data, 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  bool retvalue = g_data_output_stream_put_uint64(gobj(), data, 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  bool retvalue = g_data_output_stream_put_string(gobj(), str.c_str(), 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
