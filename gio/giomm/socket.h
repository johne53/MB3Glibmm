...
//#m4 __CONVERSION(`GSource*',`Glib::RefPtr<Glib::Source>',`Glib::RefPtr<Glib::Source>(new ::Glib::Source($3))')
  ...
  /** Sets whether @a socket should allow sending to and receiving from
   * broadcast addresses. This is <tt>false</tt> by default.
   * 
   * @newin{2,32}
   * @param broadcast Whether @a socket should allow sending to and receiving
...
/** The id of the protocol to use, or -1 for unknown.
  ...
  #ifdef GLIBMM_PROPERTIES_ENABLED
/** Whether to allow sending to and receiving from broadcast addresses.
   *
   * You rarely need to use properties because there are get_ and set_ methods for almost all of them.
   * @return A PropertyProxy that allows you to get or set the value of the property,
   * or receive notification when the value of the property changes.
