...
public:
   ...
   * <tt>OnlyShowIn</tt> and <tt>NotShowIn</tt> keys.
   * 
   * If @a desktop_env is <tt>0</tt>, then the name of the desktop set with
   ...
   * <tt>OnlyShowIn</tt> and <tt>NotShowIn</tt> keys, <tt>false</tt>
   * otherwise.
   */
