...
{
  GError* gerror = 0;
  guchar retvalue = g_data_input_stream_read_byte(gobj(), 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  gint16 retvalue = g_data_input_stream_read_int16(gobj(), 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  guint16 retvalue = g_data_input_stream_read_uint16(gobj(), 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  gint32 retvalue = g_data_input_stream_read_int32(gobj(), 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  guint32 retvalue = g_data_input_stream_read_uint32(gobj(), 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  gint64 retvalue = g_data_input_stream_read_int64(gobj(), 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  guint64 retvalue = g_data_input_stream_read_uint64(gobj(), 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  char* tmp = g_data_input_stream_read_line_utf8(gobj(), &(length), const_cast<GCancellable*>(Glib::unwrap(cancellable)), &(gerror));
  line = tmp;
  g_free(tmp);
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
...
{
  GError* gerror = 0;
  char* tmp = g_data_input_stream_read_line_utf8(gobj(), 0, const_cast<GCancellable*>(Glib::unwrap(cancellable)), &(gerror));
  line = tmp;
  g_free(tmp);
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
...
{
  GError* gerror = 0;
  char* tmp = g_data_input_stream_read_line_utf8(gobj(), &(length), 0, &(gerror));
  line = tmp;
  g_free(tmp);
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
...
{
  GError* gerror = 0;
  char* tmp = g_data_input_stream_read_line_utf8(gobj(), 0, 0, &(gerror));
  line = tmp;
  g_free(tmp);
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
...
{
  GError* gerror = 0;
  char* tmp = g_data_input_stream_read_line_finish_utf8(gobj(), Glib::unwrap(result), &(length), &(gerror));
  data = tmp;
  g_free(tmp);
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
...
{
  GError* gerror = 0;
  char* tmp = g_data_input_stream_read_line_finish_utf8(gobj(), Glib::unwrap(result), 0, &(gerror));
  data = tmp;
  g_free(tmp);
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
