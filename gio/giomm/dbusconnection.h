...
/** 
 * Flags used when sending DBusMessage<!-- -->s on a DBusConnection.
 * 
 * @newin{2,26}
 * @ingroup giommEnums
 * @par Bitwise operators:
...
public:
   ...
   * 
   * @newin{2,26}
   * @param res A AsyncResult obtained from the SlotAsyncReady passed to g_bus_get().
   ...
   * 
   * @newin{2,26}
   * @param res A AsyncResult obtained from the SlotAsyncReady passed to g_dbus_connection_new().
   * @return A DBusConnection or <tt>0</tt> if @a error is set. Free with Glib::object_unref().
   */
   ...
   * 
   * @newin{2,26}
   * @param res A AsyncResult obtained from the SlotAsyncReady passed to g_dbus_connection_close().
   ...
   * 
   * @newin{2,26}
   * @param res A AsyncResult obtained from the SlotAsyncReady passed to g_dbus_connection_flush().
   * @return <tt>true</tt> if the operation succeeded, <tt>false</tt> if @a error is set.
   */
   ...
   * 
   * @newin{2,26}
   * @param res A AsyncResult obtained from the SlotAsyncReady passed to g_dbus_connection_send_message_with_reply().
   ...
   * 
   * @newin{2,30}
   * @param bus_name A unique or well-known bus name or <tt>0</tt> if
   *  @a connection is not a message bus connection.
   * @param object_path Path of remote object.
   * @param interface_name D-Bus interface to invoke method on.
   * @param method_name The name of the method to invoke.
