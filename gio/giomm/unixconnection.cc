...
{
  GError* gerror = 0;
  bool retvalue = g_unix_connection_send_fd(gobj(), fd, 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  int retvalue = g_unix_connection_receive_fd(gobj(), 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  Glib::RefPtr<Credentials> retvalue = Glib::wrap(g_unix_connection_receive_credentials(gobj(), 0, &(gerror)));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = 0;
  bool retvalue = g_unix_connection_send_credentials(gobj(), 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
