...
:
  ...
  Glib::ObjectBase(0),
  FilterInputStream(Glib::ConstructParams(converterinputstream_class_.init(), "base_stream", const_cast<GInputStream*>(Glib::unwrap(base_stream)), "converter", Glib::unwrap(converter), static_cast<char*>(0)))
{
