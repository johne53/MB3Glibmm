...
#ifdef GLIBMM_PROPERTIES_ENABLED
Glib::PropertyProxy_ReadOnly< guint32 > InetSocketAddress::property_flowinfo() const
{
  return Glib::PropertyProxy_ReadOnly< guint32 >(this, "flowinfo");
}
#endif //GLIBMM_PROPERTIES_ENABLED

#ifdef GLIBMM_PROPERTIES_ENABLED
Glib::PropertyProxy_ReadOnly< guint32 > InetSocketAddress::property_scope_id() const
{
  return Glib::PropertyProxy_ReadOnly< guint32 >(this, "scope-id");
}
#endif //GLIBMM_PROPERTIES_ENABLED
