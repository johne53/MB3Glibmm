 ...
 * them; the man pages suggest using the entire <tt>struct
 * sockaddr_un</tt> as the name, padding the unused parts of the
 * %sun_path field with zeroes; this corresponds to
 * UNIX_SOCKET_ADDRESS_ABSTRACT_PADDED. However, many programs
